...
% ==== Points tangents B and D      
  ...
  for i=2:(Nx-1)
    for j=2:(Ny-1)
      ...
      %if((i*hx>=0.05 && i*hx<=0.25 && (i*hx-0.05)^2+(j*hy-0.05)^2>=0.04 && (i*hx-0.05)^2+(j*hy-0.45)^2>=0.04) ||... 
       % (i*hx>=0.25 && i*hx<=0.45 && (i*hx-0.45)^2+(j*hy-0.05)^2>=0.04 && (i*hx-0.45)^2+(j*hy-0.45)^2>=0.04))
